# Relics, Legendary Wargear & Loot Tables
## Treasures of the Dwarrowdelf for *The One Ring 2e*

---

> *"There lies the wealth of Khazad-dûm, not in gold or silver alone, but in blades that never dull, armour that turns the fangs of dragons, and the craftsmanship of the fathers of our folk."*

---

## 1. The Crown Relic: Durin's Axe

```
+=============================================================================+
| DURIN'S AXE (The Royal Heirloom of Khazad-dûm)                             |
+=============================================================================+
| Legend: Forged in the First Age of the world by Aulë the Smith and carried  |
| by Durin the Deathless. It has tasted the blood of dragons and Balrogs.     |
|                                                                             |
| WEAPON TYPE: Great Axe (Two-handed)                                         |
| DAMAGE: 9 | INJURY: 20 | LOAD: 4                                            |
|                                                                             |
| ENCHANTED REWARDS & BLESSINGS:                                              |
| • Rune-Scored: The axe head is carved with First Age spells of victory. All |
|   attack rolls made with Durin's Axe are Favoured.                          |
...
|   in the Lower Armoury, the mountain groans in resonance. Strategic Eye     |
|   Awareness increases by +4 immediately (triggering Alert Tier 3: Drums in  |
|   the Deep).                                                                |
+=============================================================================+
```
...
## 2. Masterwork Tunnel-Guard Relics
...
* **Craft Virtue (*Unyielding*)**:
  * **Anti-Crush & Anti-Seize**: The bearer cannot be knocked down, pushed back, or trapped in the *Seized* condition by Huge creatures (such as Cave-trolls or Slag-worms) while braced in Forward or Defensive stance.
...
* **Craft Virtue (*Gleaming Edge*)**:
  * **Subterranean Superiority**: Attacks made with this mattock against subterranean foes (Orcs, Goblins, Cave-trolls, Spiders) are permanently **Favoured**.
...
* **Craft Virtue (*Foe-Piercer*)**:
  ...
  * **Anti-Charge Impale**: If an adversary charges the wielder, the wielder strikes first in the round; if a Piercing Blow is scored, the adversary's charge is cancelled and they lose 2 Hate immediately.

### 6. The Stolen Dagger of Durin (Recovered from Grimnar)
* **Item Type**: Dagger / Short Blade
* **Damage Rating**: **4** | **Injury Rating**: **14** | **Load**: 0
* **Craft Qualities**: *Keen* (Pierce on 9–10), *Luminous Starlight* (glows with a pale blue-white luminescence whenever Orcs or Trolls are within 50 paces, completely negating darkness penalties for the bearer).

---

## 3. The Greater Hoard of the Third Deep

The Lower Armoury (Keyed Location 10) contains **120 Treasure Points** of ancient wealth, organized into portable containers for the companion Dwarf Band:

* **3 Chests of Refined Mithril-Alloy Ingots** (12 stamped ingots total, 10 Treasure Points each / 120 Treasure Points total): Worth a royal fortune in Erebor or the Blue Mountains; can be used in Fellowship Phase undertakings to forge custom enchanted gear.
* **40 Masterwork Dwarf-Forged Suits of Mail & 60 Weapons** (Swords, Axes, Crossbows, and Mattocks): Enough to fully arm 50 frontline Dwarves of Balin's colony at the East-Gate Camp, securing the Upper Mansions permanently.
* **10 Hermetically Sealed Helmets of the Tunnel-Guards**: Equipped with fine brass mesh filters that grant complete immunity to smoke and toxic fumes.

---

## 4. D66 Atmospheric Moria Scavenge Table

When heroes search despoiled chests, side-chambers, or fallen bodies, roll **D66** (roll two D6 dice: tens and units):

```
+=============================================================================================+
|                                D66 SCAVENGE & CURIO TABLE                                   |
+=============================================================================================+
| 11: A sealed tin of Old Toby pipe-weed, petrified and pungent (+1 Hope if smoked during rest)|
| 12: A heavy bronze plumb-bob engraved with the symbol of the Stonemasons' Guild.            |
| 13: An iron vial of Dwarf draught; instantly restores 4 Endurance to a weary hero.          |
| 14: A shattered mithril-inlaid buckle bearing the heraldry of the House of Nogrod.         |
| 15: A bundle of 6 high-tension steel crossbow bolts (+1 Damage on next shot).               |
| 16: A set of finely balanced lock-picks fashioned from dragon-bone (+1d to CRAFT rolls      |
|     when invoking the Burglary Trait).                                                      |
|                                                                                             |
| 21: A charred Orc skull carved with crude tallies of Dwarves slain in the First Deep.      |
| 22: A leather pouch containing 4 lumps of luminous cave-moss (provides dim light for 1 hr).|
| 23: A broken dwarven pocket sundial that spins endlessly toward True North.                 |
| 24: An intact whetstone of blue slate; grants +1 Keen to one bladed weapon for 1 battle.    |
| 25: A silver flask of pungent fire-oil; can be hurled as a burning weapon (Damage 6, Fire). |
| 26: A pair of heavy iron climbing crampons (+1d to ATHLETICS checks when scaling shafts).   |
|                                                                                             |
| 31: A scrap of parchment containing an unfinished love poem in Old Khuzdul.                 |
| 32: An Orcish bone whistle that mimics the screech of a cave bat.                           |
| 33: A silver thimble inscribed with runes of protection (Worth 2 Treasure Points).          |
| 34: A small velvet pouch containing 5 uncut mountain rubies (Worth 10 Treasure Points).     |
| 35: A hardened leather face-mask treated with tallow (grants +1d against poison gas).       |
| 36: A dwarven compass that points toward the nearest flowing subterranean stream.          |
|                                                                                             |
...
---
*Proceed to `05_gm_screen_and_play_aids.md` for the 1-page rapid GM cheat sheet, band worksheet, and pacing playbook.*
