...
* **Tactical Benefits**:
  ...
  * Einar can make **Scan** tests without risk of alerting guards.
...
* **The Escape Countdown**: The GM initiates a strict **6-Round / 6-Turn Evacuation Timer**. If the Company does not reach and secure Keyed Location 2 (The Upper Gatehouse) before the countdown expires, the main vertical shafts back to Thrym's Safe Haven are collapsed or sealed with iron gates, forcing a desperate detour through the lethal lower goblin pits!
...
----------------------------------------------------------------------------------------
 ...
 Sounding Khoril's Battle-horn of the Realm        +5 Noise    INSTANT ALERT 3! (+2 Eye)
...
* **Gaining Eye Awareness**:
  ...
  * Sounding Khoril's *Battle-horn of the Realm*: **+2 Eye Awareness**.
...
### 3.1 The Balrog Neurotoxic Miasma (Poison of the Armouries)
